    ...
    <main className="min-h-screen bg-[#020817] px-4 py-12 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight">Training Programs</h1>
          <p className="mt-5 text-base leading-7 text-slate-300">
            Tailored training for organizations, NGOs, healthcare teams, and institutions seeking
            practical AI and analytics capability building.
          </p>
        </div>
            ...
            >
              ...
              <div className="mt-6 grid gap-3">
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-200">{program.audience}</p>
                </div>
                <div>
                  <p className="text-sm text-slate-500">Duration</p>
                  <p className="text-sm font-medium text-slate-200">{program.duration}</p>
                </div>
                <div>
                  <p className="text-sm text-slate-500">Format</p>
                  <p className="text-sm font-medium text-slate-200">{program.format}</p>
                </div>
              </div>

              <div className="mt-6">
                <p className="text-sm font-medium text-slate-300">Program highlights</p>
