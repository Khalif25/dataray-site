...
const course = academyCourses.find((item) => item.slug === "sql");
      ...
      <div className="mx-auto max-w-5xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base leading-7 text-slate-300">
            This course is currently being prepared for release. The page is available now so
            learners can understand the planned scope, structure, and expected learning outcomes.
          </p>
        </div>
